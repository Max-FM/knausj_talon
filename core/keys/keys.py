...
default_alphabet = "air bat cap drum each fine gust heart ink jury crunch look made near oval pit quench red sun trap urge vest whale plex yank zip".split(
    " "
)

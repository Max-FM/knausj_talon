...
(pace | paste) cell: user.vscode("notebook.cell.paste")
(pace | paste) [cell] (above | up): user.vscode("notebook.cell.pasteAbove")
...
clear outputs: user.vscode("notebook.clearAllCellsOutputs")
